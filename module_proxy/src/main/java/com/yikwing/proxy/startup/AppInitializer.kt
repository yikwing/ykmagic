...
class AppInitializer(
    ...
    private fun discover(taskList: List<Initializer<*>>): List<Initializer<*>> {
        ...
        buildDependencyGraph(taskList, inDeCountMap, zeroDeque, dependents)

        val sortedList = topologicalSort(inDeCountMap, zeroDeque, dependents)
    ...
    private fun buildDependencyGraph(
        taskList: List<Initializer<*>>,
        inDeCountMap: MutableMap<Initializer<*>, Int>,
        zeroDeque: ArrayDeque<Initializer<*>>,
        dependents: MutableMap<Class<*>, MutableList<Initializer<*>>>,
    ) {
    ...
    private fun topologicalSort(
        inDeCountMap: MutableMap<Initializer<*>, Int>,
        zeroDeque: ArrayDeque<Initializer<*>>,
        dependents: Map<Class<*>, List<Initializer<*>>>,
    ): List<Initializer<*>> {
